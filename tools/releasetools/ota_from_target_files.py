...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.onui-pendro.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.onui-pendro.device")

  script.Print("----------------------------------------------");
  script.Print("              OnUI-Pendro-1.5");
  script.Print("               by RaghuVarma");
  script.Print("----------------------------------------------");
